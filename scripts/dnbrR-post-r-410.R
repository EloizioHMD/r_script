...
plot(pantanal_lim["name_biome"]) # Verificação da polígonal
...
# Mosaico
b2_2019_mosaico <- mosaic(list_raster[["2019.b2.1"]], list_raster[["2019.b2.2"]], fun = mean)

b7_2019_mosaico <- mosaic(list_raster[["2019.b7.1"]], list_raster[["2019.b7.2"]], fun = mean)

b2_2020_mosaico <- mosaic(list_raster[["2020.b2.1"]], list_raster[["2020.b2.2"]], fun = mean)

b7_2020_mosaico <- mosaic(list_raster[["2020.b7.1"]], list_raster[["2020.b7.2"]], fun = mean)
...
# Fonte: [USGS](http://lakestatesfiresci.net/docs/BurningIssues2020/Burning%20Issues%202020-RemoteSensingHandouts/LAv4_BR_CheatSheet.pdf)
